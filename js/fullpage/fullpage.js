        ...
        */
        function performMovement(v) {
            ...
            if (options.css3 && options.autoScrolling && !options.scrollBar) {
                if (v.anchorLink == 'footers') { //当滚屏到最后一屏时间 
                    var footer_a = $('#_news')[0].scrollHeight;//倒数第二屏的高度  
                    var footer_h = $('#footer')[0].scrollHeight;  //footer的高度
                    // console.log($('#_news')[0].scrollHeight)
